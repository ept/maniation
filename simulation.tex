...
figure~\ref{rigidBodySummary}. A force \ve{F} may be applied to any point $\ve{r}'$ of
...
already falls in this category. General solutions can then only be approximated numerically.
