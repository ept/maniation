...
class BubbleImpl implements de.kleppmann.maniation.scene.Bubble, de.kleppmann.maniation.scene.XMLElement {
    
    private javax.xml.namespace.QName _tagName = new javax.xml.namespace.QName("http://kleppmann.de/maniation/scene", "bubble");
    private de.realityinabox.databinding.libs.AttributeMap _attributes = new de.realityinabox.databinding.libs.AttributeMap(new de.kleppmann.maniation.scene.BubbleImpl.MyAttributes());
    private de.kleppmann.maniation.scene.XMLElement _parent;
    private de.kleppmann.maniation.scene.XMLDocument _document;
    private de.kleppmann.maniation.scene.BubbleImpl.MyHandler _handler = new de.kleppmann.maniation.scene.BubbleImpl.MyHandler();
    private de.kleppmann.maniation.scene.BubbleImpl.MyChildren _children = new de.kleppmann.maniation.scene.BubbleImpl.MyChildren();
    
    BubbleImpl(de.kleppmann.maniation.scene.XMLDocument document, de.kleppmann.maniation.scene.XMLElement parent) {
    ...
    private class MyAttributes extends de.realityinabox.databinding.libs.AttributeSet {
        ...
        javax.xml.namespace.QName _radiusAttribute = new javax.xml.namespace.QName("", "radius");
        ...
        public java.lang.String add(javax.xml.namespace.QName key, java.lang.String value) {
            ...
            if (key.equals(_radiusAttribute)) {
                _result = java.lang.Double.toString(getRadius());
                setRadius(java.lang.Double.parseDouble(value));
            } else
        ...
        public javax.xml.namespace.QName getKey(int index) {
            ...
            if (index == 3) return _radiusAttribute;
        ...
        public java.lang.String getValue(int index) {
            ...
            if (index == 3) return java.lang.Double.toString(getRadius());
            throw new IllegalArgumentException();
        }
    ...
    private class MyHandler extends org.xml.sax.helpers.DefaultHandler {
        ...
        public void endElement(java.lang.String namespaceURI, java.lang.String localName, java.lang.String qName) throws org.xml.sax.SAXException {
            if (getParent() != null) getParent().getChildren().add(BubbleImpl.this);
