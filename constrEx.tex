...
the line and \ve{v} points in the line's direction. In this derivation we shall assume that the
...
Now we can turn to calculating the derivatives of \ve{c}:
\begin{eqnarray}
...
Finally we subtract the terms generated by $\m{J}\ddot{\ve{x}}$ from $\ddot{\ve{c}}$ and separate
